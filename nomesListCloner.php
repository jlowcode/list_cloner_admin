<?php
	...
	$query->clear()
		  ...
		  ->from($db->quoteName('admin_fabrik_lists') . 'AS l')
		  ->where('l.id = "' . $idlista . '"');
	...
	$query->clear()
		  ...
		  ->from($db->quoteName('adm_cloner_modelos') . 'AS m')
		  ->join('LEFT', $db->quoteName('adm_cloner_modelos_repeat_extra_lists') . 'AS e ON m.id = e.parent_id')
		  ->join('LEFT', $db->quoteName('admin_fabrik_lists') . 'AS l ON e.extra_lists = l.id')
		  ->join('LEFT', $db->quoteName('admin_fabrik_lists') . 'AS le ON m.main_list = le.id')
